#ifndef WL_WINDOW_MESSAGES_NAMES_HPP
#define WL_WINDOW_MESSAGES_NAMES_HPP

#include <Windows.h>

namespace Utility 
{
    LPCTSTR getWndMsgName(UINT MsgValue)
    {
        switch (MsgValue)
        {
        ...
        default:     return TEXT("UNDEFINED_MESSAGE");
        }
    }
}

#endif //!WL_WINDOW_MESSAGES_NAMES_HPP